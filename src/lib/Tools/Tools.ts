...
export const P = (props: any, children?: any) => CreateTag("p", props, children);
export const Span = (props: any) => CreateTag("span", props);
export const Input = (props: any) => CreateTag("input", props);
export const Img = (props: any) => CreateTag("img", props);
export const Button = (props: any) => CreateTag("button", props);
export const Fragment = (children = []) => CreateTag("fragment", {}, children);
export const LinkButton = (props: any) => CreateTag("a", props);
export const Br = () => document.createElement("br");

export function Select({ className, value, options, onChange }: any) {
...
export function Video(props: any, children: any) {
  props.id = "video";
